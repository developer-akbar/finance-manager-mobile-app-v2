const fs = require('fs');
const { resolveInvestmentSubAccount, resolveInvestmentAccounts } = require('./src/utils/brokerageAccounting.js');

// Read finman_2026-08-31_Zerodha_final_v2.csv
