...
console.log('Fareeda Groww after Test 1:', computeBalance(rowsAfter1, 'Liquid Mutual Funds', 'Fareeda Groww'));
...
console.log('Ammi Groww after Test 2:   ', computeBalance(rowsAfter2, 'Liquid Mutual Funds', 'Ammi Groww'));
