...
const outPath = 'scratch/finman_CAS_enriched_master_preview_v2.csv';
fs.writeFileSync(outPath, stringifyCSV(finalEnrichedMaster), 'utf8');
console.log(`Updated preview CSV: scratch/finman_CAS_enriched_master_preview_v2.csv`);
