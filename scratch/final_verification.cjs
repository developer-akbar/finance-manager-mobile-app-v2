...
// 1. Audit of the 39 dividend records
...
console.log('=== DIVIDEND AUDIT ===');
console.log(`Total dividend records: ${divRows.length}`);
console.log(`Total dividend sum in CSV: ₹${sumDiv.toFixed(2)}`);
console.log(`Zerodha Statement Reported: ₹2171.00`);
console.log(`Difference: ₹${(2171.00 - sumDiv).toFixed(2)}`);
...
console.log('\n==================================================');
console.log('ZERODHA VALIDATION OUTPUT');
console.log('==================================================');
...
console.log('\n==================================================');
console.log('SHARE MARKET TOTALS');
console.log('==================================================');
