...
console.log('=== OFFLINE CAS ENRICHMENT AUDIT & MATCHING REPORT ===');
console.log('Total Existing Transactions in FinMan:', existingRows.length);
console.log('Total CAS-derived Transactions:', casRows.length);
