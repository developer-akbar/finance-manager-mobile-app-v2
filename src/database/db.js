...
const applySchema = async (db) => {
  ...
  try { await db.run(`ALTER TABLE inventory ADD COLUMN category TEXT DEFAULT ''`); } catch {}
  try { await db.run(`ALTER TABLE inventory ADD COLUMN brand TEXT DEFAULT ''`); } catch {}
